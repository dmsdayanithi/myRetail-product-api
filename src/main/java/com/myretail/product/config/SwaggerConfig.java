...
public class SwaggerConfig {
	...
	private ApiInfo apiEndPointsInfo() {
		return new ApiInfoBuilder().title("My Retail Product Service").description("Get and update product details.")
				.contact(new Contact("Dayanithi Devarajan", "", "dmsdayanithi@gmail.com")).version(version).build();
	}
}
